...
public class GetCustomerByIdUseCase(ICustomerService customerService) : UseCase<GetCustomerByIdUseCase.Input, GetCustomerByIdUseCase.Output>
{
    ...
    public override Output? Execute(Input getInput)
    {
        ...
        var output = customer == null ? null : new Output(customer.GetId(), customer.GetCpf(), customer.GetEmail(), customer.GetName());
        return output;
    }
